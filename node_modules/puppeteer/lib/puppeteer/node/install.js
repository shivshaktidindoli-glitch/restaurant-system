...
export async function downloadBrowsers() {
    ...
    if (failures.length > 0) {
        ...
        throw new Error('Failed to download one or more browsers. Run `npx puppeteer browsers install` to try again, or `npx puppeteer browsers clear` first if the cache holds an unfinished install.');
    }
}
/**
 * @internal
